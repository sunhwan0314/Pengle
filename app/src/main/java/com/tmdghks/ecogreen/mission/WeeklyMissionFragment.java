...
public class WeeklyMissionFragment extends Fragment implements MissionAdapter.OnMissionCompleteListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerWeeklyMissions);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new MissionAdapter(getContext(), missionManager.getWeeklyMissions(), this, missionManager);
